        ...
        <section className={`${styles.footerSection}`}>
            <div className={`${styles.footer}`}>
                <div>
                    ...
                    <a
                        className={`${styles.socialLink} mb-3`}
                        href="https://github.com/vaishnavme/gardnup-frontend"
                        rel="noreferrer"
                        target="_blank"
                    >
                    ...
                    <div>
                        ...
                        <div>
                            <ul className={`${styles.sociallist}`}>
                                ...
                                <li>
                                    <a
                                        href="https://www.linkedin.com/in/vaishnav-chandurkar"
                                        className={`${styles.socialLink}`}
                                        rel="noreferrer"
                                        target="_blank"
                                    >
                                ...
                                <li>
                                    <a
                                        href="https://twitter.com/vaishnavs0?=09"
                                        className={`${styles.socialLink}`}
                                        rel="noreferrer"
                                        target="_blank"
                                    >
                ...
                <div className={`${styles.siteMenu}`}>
                    ...
                    <ul className={`${styles.siteLinks}`}>
                        <li>
                            <NavLink to="/" className={`${styles.socialLink}`}>
                                Home
                            </NavLink>
                        </li>
                        <li>
